                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                        ...
                                        <li>
                                            <a class="dropdown-item delete_task_btn" data-id="{{ $task->id }}"
                                                href="#">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body alert-info">
                <div id="inProgressTaskBoard">
                    @foreach (collect($project->tasks)->sortBy('serial_number')->where('status', 'in_progress')
    as $task)
                        <div class="task-item mb-2" data-id="{{ $task->id }}">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>{{ $task->title }}</span>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body alert-success">
                <div id="completeTaskBoard">
                    @foreach (collect($project->tasks)->sortBy('serial_number')->where('status', 'complete')
    as $task)
                        <div class="task-item mb-2" data-id="{{ $task->id }}">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span>{{ $task->title }}</span>
